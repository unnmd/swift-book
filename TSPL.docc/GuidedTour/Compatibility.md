...
они включены либо по умолчанию, либо с помощью флага предстоящей функции.
Однако, чтобы включить строгую проверку параллелизма, 
...
- Функции, возвращающие непрозрачный тип, требуют среды выполнения Swift 5.1.
...
Параллелизм требует режима языка Swift 5 
и версии стандартной библиотеки Swift, 
которая предоставляет соответствующие типы для параллелизма. 
На платформах Apple установите целевую платформу как минимум iOS 13, 
macOS 10.15, tvOS 13, watchOS 6 или visionOS 1.

Цель, написанная на Swift 6,
может зависеть от цели, написанной на Swift 5, Swift 4.2 или Swift 4, 
и наоборот. 
