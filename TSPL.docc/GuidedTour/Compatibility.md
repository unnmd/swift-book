...
Поддержка конкурентности требует версии 5.10 или более поздней,
...
Цель, написанная в 5.10, может зависеть от
...
вы можете постепенно мигрировать свой код с Swift 4 на 5.10,
